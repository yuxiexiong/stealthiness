...
Return only JSON: {"diagnosis":"brief evidence-based conclusion", "alternative":"competing explanation", "uncertainty":"limits", "predictions":[{"condition_id":"test_a", "fact_id":"a", "probabilities":{"unchanged":0.5,"changed":0.4,"unjudgeable":0.1},"evidence":"brief evidence"}, ...]}. Cover all queries and both facts exactly once."""
